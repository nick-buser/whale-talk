...
import { useSize, fmtSec } from '../lib/hooks'
import { whaleAudio } from '../lib/audio'
import { Eyebrow } from '../components/Eyebrow'

function CodaPlayer({ coda, autoplay }: {
  coda: typeof CODAS[0]
  ...
  const x = (t: number) => pad.l + (t / totalDur) * (W - pad.l - pad.r)
        ...
        {coda.intervals.map((iv, i) => {
          ...
          return (
            <g key={i} transform={`translate(0, ${H/2 + 40})`}>
              ...
              <text x={cx2} y={18} fill="#b6c8df" fontFamily="IBM Plex Mono" fontSize="10" textAnchor="middle">
